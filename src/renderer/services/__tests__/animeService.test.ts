...
import GET, { axiosApiInstance } from 'renderer/services/fetchApi';
...
const mockedApi = axiosApiInstance as jest.Mocked<AxiosStatic>;
jest.mock('renderer/services/fetchApi', () => ({
...
describe('Anime Services', () => {
  it('should return AnimeType from API successfully', async () => {
    ...
    const response = await GET('https://api.jikan.moe/v4/anime');
